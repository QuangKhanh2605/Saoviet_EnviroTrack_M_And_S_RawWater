...
uint8_t _Cb_R_ModbusRTU_REG_DO_Per_Measure(sData *str, uint16_t Pos);

uint8_t _Cb_R_ModbusRTU_REG_Salt_Compensation(sData *str, uint16_t Pos);
uint8_t _Cb_W_ModbusRTU_REG_Salt_Compensation(sData *str, uint16_t Pos);
/*============================ Struct var ============================*/
...
//      id ENUM                         id Reg      Length          Cb_Read         Cb_Write
      ...
      {_E_REGISTER_DO_PER,              0x0006,     2,        _Cb_R_ModbusRTU_REG_DO_Per_Measure, NONE_Register_CallBack},
      {_E_REGISTER_SALT_COMPENSATION,   0x0008,     2,        _Cb_R_ModbusRTU_REG_Salt_Compensation,  _Cb_W_ModbusRTU_REG_Salt_Compensation},
};
...
{
    uint32_t hexValue = 0;
    hexValue = Handle_Float_To_hexUint32(sSensor_DO.Oxy_Mg_L_Filter_f);
...
{
    uint32_t hexValue = 0;
    hexValue = Handle_Float_To_hexUint32(sSensor_DO.temp_Filter_f);
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 8;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 24;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 16;
...
/*----------- _E_REGISTER_DO_PERCENT -----------*/
uint8_t _Cb_R_ModbusRTU_REG_DO_Per_Measure(sData *str, uint16_t Pos)
{
    uint32_t hexValue = 0;
    hexValue = Handle_Float_To_hexUint32(sSensor_DO.Oxy_Percent_Filter_f);
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 8;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 24;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 16;
...
/*----------- _E_REGISTER_DO_COMPENSATION -----------*/
uint8_t _Cb_R_ModbusRTU_REG_Salt_Compensation(sData *str, uint16_t Pos)
{
    uint32_t hexValue = 0;
    hexValue = Handle_Float_To_hexUint32(sSaltPSU_RecvMaster.SaltPSU_f );
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 8;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 24;
    sLogData_ModbusRTU.Data_a8[sLogData_ModbusRTU.Length_u16++] = hexValue >> 16;
...
uint8_t _Cb_W_ModbusRTU_REG_Salt_Compensation(sData *str, uint16_t Pos)
{
    ...
    sSaltPSU_RecvMaster.SaltPSU_f = Convert_F;
    
    sSaltPSU_RecvMaster.StateConnect = _SENSOR_CONNECT;
    fevent_enable(sEventAppSensor, _EVENT_DETECT_SALT_RECV);
    return 1;
}
