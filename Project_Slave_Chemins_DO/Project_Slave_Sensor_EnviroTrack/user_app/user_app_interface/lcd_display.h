...
typedef struct
{
    ...
    int32_t     Oxy_Mg_L_Filter_i32;
    int32_t     Oxy_Percent_Filter_i32;
    int32_t     Temp_Filter_i32;
    
    int32_t     Oxy_Mg_L_Offset_i32;
    int32_t     Oxy_Percent_Offset_i32;
    int32_t     temp_Offset_i32;
    
    int32_t     Salt_Compensation_i32;
}sParameter_Display;
